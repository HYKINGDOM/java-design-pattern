...
public class AuthenticationServerConfig
    ...
    public AuthenticationServerConfig(AuthenticationManager authenticationManager, PasswordEncoder passwordEncoder) {
...
//                .resourceIds("abc", "def")
                ...
                .redirectUris(
                        "https://api.weidoc.cn/login/oauth2/code/gateway",
                        "http://gateway:20001/login/oauth2/code/gateway"
                )
                // 自动确认，不需要用户点击按钮！
                .autoApprove(true)
        ;
