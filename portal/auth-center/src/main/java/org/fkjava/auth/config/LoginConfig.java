...
public class LoginConfig extends WebSecurityConfigurerAdapter {
    ...
    public LoginConfig(RemoteUserService userService, CommonConfigProperties properties) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        SavedRequestAwareAuthenticationSuccessHandler successHandler = this.successHandler();
        http
                .authorizeRequests()
...
//                .usernameParameter("username")//
                ...
                .logoutSuccessUrl("/uc/login?logout")
    ...
    private SavedRequestAwareAuthenticationSuccessHandler successHandler() {
        ...
        handler.setDefaultTargetUrl(LoginConfig.DEFAULT_SUCCESS_URL);
    ...
    private AuthenticationEntryPoint authenticationEntryPoint() {
        return new LoginUrlAuthenticationEntryPoint("/uc/login") {
            @Override
